...
@Service
public class FootballApiSyncServiceImpl implements FootballApiSyncService {

    private final FootballApiClient footballApiClient;
    private final PlayerRepository playerRepository;
    private final PlayerMapper playerMapper;

    public FootballApiSyncServiceImpl(FootballApiClient footballApiClient, PlayerRepository playerRepository, PlayerMapper playerMapper) {
